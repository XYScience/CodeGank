...
public class NestedScrollWebView extends WebView implements NestedScrollingChild {
    ...
    private static String TAG = NestedScrollWebView.class.getSimpleName();
    ...
    public NestedScrollWebView(Context paramContext) {
        this(paramContext, null);
    }

    public NestedScrollWebView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NestedScrollWebView(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
...
//                    setJavaScriptEnable(true);
    ...
    public static class MyWebViewClient extends WebViewClient {
        ...
        public final boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString) {
            if ((paramWebView instanceof NestedScrollWebView)) {
                ...
                if (!((NestedScrollWebView) paramWebView).isBeingDragged())
